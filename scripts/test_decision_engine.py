...
def main():
    ...
    print(f"Head deviation threshold: {engine.head_deviation_threshold:.1f}°")
    print(f"Sustained frames required: EAR={engine.ear_sustained_frames}, Head={engine.head_sustained_frames}, MAR={engine.mar_sustained_frames}")
    print("=" * 80)
